...
<Block type="full">
  <Figure>
    ...
    />
    <Caption>
      Comparison of decadally-averaged temperature difference from 2000-2009 and 2010-2019 with socioeconomic vulnerability from 2018. (Hopefully we can add - Greatest changes in temperature change are in locations with the highest socioeconomic vulnerability.
    </Caption>
  </Figure>
</Block>
